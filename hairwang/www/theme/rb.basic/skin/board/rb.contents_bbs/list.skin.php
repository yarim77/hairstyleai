...
기본값은 4열 입니다.
-->
<link rel="stylesheet" href="<?php echo $board_skin_url ?>/style.php?bo_gallery_width=<?php echo $bo_gallery_width; ?>&bo_mobile_gallery_width=<?php echo $bo_mobile_gallery_width; ?>&bo_gallery_height=<?php echo $bo_gallery_height; ?>&bo_mobile_gallery_height=<?php echo $bo_mobile_gallery_height; ?>&columns=<?php echo $board['bo_gallery_cols']; ?>">
...
<div class="rb_bbs_wrap" id="scroll_container" style="width:<?php echo $width; ?>">
    ...
    <ul class="rb_bbs_list rb_gallery_grid">
        ...
        <div class="bbs_prd_list">
            ...
            <div class="bbs_prd_list_wrap" onclick="location.href='<?php echo $wr_href ?>';">
                <ul class="bbs_prd_list_img">
                    <?php echo run_replace('thumb_image_tag', $img_content, $thumb); ?>
                </ul>
                <ul class="bbs_prd_list_con">
                    
                    <?php if($list[$i]['ca_name'] || $list[$i]['wr_comment'] > 0) { ?>
                    ...
                    <li class="font-B info_pri_wrap main_color">
                        <dd><?php echo isset($wr_1[0]) ? get_text($wr_1[0]) : ''; ?></dd>
                    </li>
                    <?php } ?>
                    ...
                    <?php if($list[$i]['wr_4']) { ?>
                        <li><span class="font-B"><?php echo get_text($list[$i]['wr_4']) ?></span></li>
                    <?php } ?>
                    <?php if($list[$i]['icon_new'] || $list[$i]['icon_hot']) { ?>
                        <li class="gallery-item-ico">
