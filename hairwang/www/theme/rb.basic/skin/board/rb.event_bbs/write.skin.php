...
<div class="rb_bbs_wrap rb_bbs_write_wrap">
        ...
        <div id="autosave_wrapper" class="write_div">
            ...
            <ul class="autosave_wrapper_ul2">
                ...
                <div id="autosave_pop">
                    ...
                    <?php } ?>
                    <div class="autosave_guide">
                        기존 내용과 다른 경우 저장됩니다.<br>
                        불러오기 또는 임시저장을 하셨다면, 해당 데이터에 덮어쓰기 됩니다.
                    </div>
                    <div><button type="button" class="autosave_close font-B">닫기</button></div>
                </div>
            </ul>
            <?php } ?>
        </div>
    ...
    <div class="rb_inp_wrap new_bbs_border_wrap">
        <ul>
            ...
            <input type="text" name="wr_1" class="datepicker_start datepicker" value="<?php echo isset($write['wr_1']) ? $write['wr_1'] : ''; ?>" id="wr_1" class="input" placeholder="시작일" required autocomplete="off" readonly>
            <input type="text" name="wr_2" class="datepicker_end datepicker" value="<?php echo isset($write['wr_2']) ? $write['wr_2'] : ''; ?>" id="wr_2" class="input" placeholder="종료일" required autocomplete="off" readonly>　
