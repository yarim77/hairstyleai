...
기본값은 4열 입니다.
-->
<link rel="stylesheet" href="<?php echo $board_skin_url ?>/style.php?columns=<?php echo $board['bo_gallery_cols']; ?>&img_height=<?php echo $board['bo_gallery_height']; ?>">
    ...
    <ul class="rb_bbs_list rb_gallery_grid">
        ...
        <div class="gallery-item">
            <ul class="gallery-item-img">
                ...
                <span class="prod_img"><?php echo get_member_profile_img($list[$i]['mb_id'], 60, 60); ?></span>
