...
<header id="header">
        ...
        <div class="inner">
                ...
                <li>
                    <a href="<?php echo G5_URL ?>" alt="<?php echo $config['cf_title']; ?>">
                        <?php if (!empty($rb_builder['bu_logo_pc']) && !empty($rb_builder['bu_logo_pc_w'])) { ?>
                            <img src="<?php echo G5_URL ?>/data/logos/pc?ver=<?php echo G5_SERVER_TIME ?>"
                                alt="<?php echo $config['cf_title']; ?>">
                        <?php } else { ?>
                            <img src="<?php echo G5_THEME_URL ?>/rb.img/logos/pc.png?ver=<?php echo G5_SERVER_TIME ?>"
                                alt="<?php echo $config['cf_title']; ?>">
                        <?php } ?>
                    </a>
                </li>
                        ...
                        <a href="<?php echo G5_URL ?>" alt="<?php echo $config['cf_title']; ?>">
                            <picture id="logo_img">
                                <?php if (!empty($rb_builder['bu_logo_mo']) && !empty($rb_builder['bu_logo_mo_w'])) { ?>
                                    <source id="sourceSmall"
                                        srcset="<?php echo G5_URL ?>/data/logos/mo?ver=<?php echo G5_SERVER_TIME ?>"
                                        media="(max-width: 1024px)">
                                <?php } else { ?>
                                    <source id="sourceSmall"
                                        srcset="<?php echo G5_THEME_URL ?>/rb.img/logos/mo.png?ver=<?php echo G5_SERVER_TIME ?>"
                                        media="(max-width: 1024px)">
                                <?php } ?>

                                <?php if (!empty($rb_builder['bu_logo_pc']) && !empty($rb_builder['bu_logo_pc_w'])) { ?>
                                    <source id="sourceLarge"
                                        srcset="<?php echo G5_URL ?>/data/logos/pc?ver=<?php echo G5_SERVER_TIME ?>"
                                        media="(min-width: 1025px)">
                                <?php } else { ?>
                                    <source id="sourceLarge"
                                        srcset="<?php echo G5_THEME_URL ?>/rb.img/logos/pc.png?ver=<?php echo G5_SERVER_TIME ?>"
                                        media="(max-width: 1024px)">
                                <?php } ?>

                                <?php if (!empty($rb_builder['bu_logo_pc']) && !empty($rb_builder['bu_logo_pc_w'])) { ?>
                                    <img id="fallbackImage"
                                        src="<?php echo G5_URL ?>/data/logos/pc?ver=<?php echo G5_SERVER_TIME ?>"
                                        alt="<?php echo $config['cf_title']; ?>" class="responsive-image">
                                <?php } else { ?>
                                    <img id="fallbackImage"
                                        src="<?php echo G5_THEME_URL ?>/rb.img/logos/pc.png?ver=<?php echo G5_SERVER_TIME ?>"
                                        alt="<?php echo $config['cf_title']; ?>" class="responsive-image">
                                <?php } ?>
                            </picture>
                        </a>
            ...
            <div class="search_top_wrap pc_only">
                <form name="fsearchbox" method="get" action="<?php echo G5_BBS_URL ?>/search.php"
                    ...
                    <div class="search_top_wrap_inner">
                        ...
                        <input type="text" value="" name="stx" class="font-B" placeholder="어떤 서비스가 필요하세요?"
                            maxlength="20">
                        <button type="submit">
                    ...
                    <li class="hd__mnav__list">
                        <div class="sub__menu sub__menu01">
                            <ul>
                                ...
                                <li><a href="/ai_hairstyle">AI 스타일</a></li>
                                <li><a
                                        href="https://hairwang.com/notice/%ED%97%A4%EC%96%B4%EC%99%95-%EC%B1%84%EC%9A%A9%EC%A0%95%EB%B3%B4-%EB%94%94%EC%9E%90%EC%9D%B4%EB%84%88-%EC%97%AC%EB%9F%AC%EB%B6%84%EA%B3%BC-%ED%95%A8%EA%BB%98-%EB%A7%8C%EB%93%AD%EB%8B%88%EB%8B%A4/">채용정보</a>
                                </li>
            ...
            <div class="hd__right__nav pc_only">
                ...
                <ul class="snb_wrap">
                    <li class="qm_wrap">
                        <?php if ($is_member) { ?>
                            <a href="<?php echo G5_BBS_URL ?>/memo.php" alt="쪽지"
                                onclick="win_memo(this.href); return false;" title="쪽지">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M15.2715 2.33675L2.67946 6.88975L6.87446 9.31775L10.5735 5.61775C10.7611 5.43024 11.0155 5.32495 11.2808 5.32505C11.5461 5.32514 11.8005 5.43061 11.988 5.61825C12.1755 5.80589 12.2808 6.06033 12.2807 6.3256C12.2806 6.59087 12.1751 6.84524 11.9875 7.03275L8.28746 10.7328L10.7175 14.9268L15.2715 2.33675ZM15.5945 0.0927503C16.7895 -0.34025 17.9475 0.81775 17.5145 2.01275L12.2325 16.6178C11.7985 17.8158 10.1625 17.9618 9.52346 16.8587L6.30646 11.3008L0.748462 8.08375C-0.354538 7.44475 -0.208537 5.80875 0.989463 5.37475L15.5945 0.0927503Z"
                                        fill="#09244B" />
                                </svg>
                    ...
                    <li class="member_info_wrap">
                        <?php if ($is_member) { ?>
                            <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=<?php echo G5_BBS_URL ?>/register_form.php"
                                class="font-B notranslate"><?php echo $member['mb_nick'] ?></a>　<a
                                href="<?php echo G5_BBS_URL; ?>/point.php" target="_blank" class="win_point"><span
                                    class="font-H"><?php echo number_format($member['mb_point']); ?> P</span></a>
                        <?php } ?>
                    </li>
                    <li class="my_btn_wrap">
                        <?php if ($is_member) { ?>
                            <button type="button" alt="로그아웃" class="btn_round"
                                onclick="location.href='<?php echo G5_BBS_URL ?>/logout.php';">로그아웃</button>
                            <button type="button" alt="마이페이지" class="btn_round arr_bg font-B"
                                onclick="location.href='<?php echo G5_URL; ?>/rb/home.php?mb_id=<?php echo $member['mb_id']; ?>';">My</button>
                        <?php } else { ?>
                            <button type="button" alt="로그인" class="btn_round"
                                onclick="location.href='<?php echo G5_BBS_URL; ?>/login.php?url=<?php echo $_SERVER['REQUEST_URI']; ?>';">로그인</button>
                            <button type="button" alt="회원가입" class="btn_round arr_bg font-B"
                                onclick="location.href='<?php echo G5_BBS_URL ?>/register.php';">회원가입</button>
                        <?php } ?>
                    </li>
                    <div class="cb"></div>
                </ul>
                ...
                <div id="search_box_wrap">
                    <form name="fsearchbox" method="get" action="<?php echo G5_BBS_URL ?>/search.php"
                        onsubmit="return fsearchbox_submit(this);">
                        <ul>
                            <input type="text" name="stx" maxlength="20" class="w100 font-B" id="ser_inp_fc"
                                placeholder="통합검색">
    ...
    <div id="mobile_search_bar" class="mobile_search_area">
        <div class="search_top_wrap">
            <form name="mobile_fsearchbox" method="get" action="<?php echo G5_BBS_URL ?>/search.php"
                onsubmit="return fsearchbox_submit(this);">
                <div class="search_top_wrap_inner">
                    <input type="hidden" name="sfl" value="wr_subject||wr_content">
                    <input type="hidden" name="sop" value="and">
                    <input type="text" name="stx" maxlength="20" class="font-B" placeholder="검색어를 입력하세요"
                    ...
                    foreach ($menu_datas as $row) {
                        ...
                        <li>
                            <a href="<?php echo $row['me_link']; ?>" target="_<?php echo $row['me_target']; ?>"
                                class="font-B"><?php echo $row['me_name'] ?></a>
                            <?php
                            $k = 0;
