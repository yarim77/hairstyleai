...
add_stylesheet('<link rel="stylesheet" href="'.$poll_skin_url.'/style.css?ver='.G5_TIME_YMDHIS.'">', 0);
?>
...
<div id="poll_result" class="new_win">
    ...
    <div class="new_win_con2">
        <!-- 설문조사 결과 그래프 시작 { -->
        <span class="poll_all font-B">전체 <?php echo $nf_total_po_cnt ?>표</span>
            ...
            <ol>
                ...
                <li class="<?php echo $poll_1st_class; ?>">
                    ...
                    <div class="poll_numerical">
                    	<span class="poll_cnt"><?php echo $list[$i]['cnt'] ?> 표</span>
                    	<span class="poll_percent font-H"><?php echo number_format($list[$i]['rate'], 1) ?> %</span>
                    </div>
                </li>
            	<?php }  ?>
            </ol>
        ...
        <section id="poll_result_cmt">
            ...
            <article>
                <header>
                    ...
                    <span class="poll_cmt_del"><?php if ($list2[$i]['del']) { echo $list2[$i]['del']."<img src=\"".G5_THEME_URL."/rb.img/icon/icon_close.svg\"></a>"; }  ?></span>
                </header>
                <p>
            ...
            <div class="poll_guest">
                ...
                <input type="text" name="pc_name" id="pc_name" required class="full_input required mt-10" size="20" placeholder="이름">
            </div>
