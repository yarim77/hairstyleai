...
<div id="m_pv_sod_frm" class="personal_pay_wrap">
    ...
    <div class="sod_right">
        ...
        if ($default['de_iche_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="pp_settle_iche" name="pp_settle_case" value="계좌이체" '.$checked.'> <label for="pp_settle_iche">'.$escrow_title. ($default['de_pg_service'] == 'toss' ? '퀵계좌이체' :'계좌이체') . '</label></li>'.PHP_EOL;
            $checked = '';
        }
