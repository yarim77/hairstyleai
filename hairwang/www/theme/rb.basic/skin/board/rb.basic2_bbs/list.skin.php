...
<div class="rb_bbs_wrap" id="scroll_container" style="width:<?php echo $width; ?>">
    ...
    <!-- 카테고리 { -->
    <?php if ($is_category) { ?>
    <nav id="bo_cate" class="swiper-container swiper-container-category" style="margin-bottom:0px !important;">
    ...
    <ul class="rb_bbs_list">
        ...
        <div class="rb-board-container" <?php if ($is_category) { ?><?php } else { ?>style="border-top:1px solid #eee; !important"<?php } ?>>
                ...
                <table class="rb-board-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if ($is_category) { ?>
                            <td class="rb-board-ca board_pc" nowrap>
                               
                                <?php if ($is_category && $list[$i]['ca_name']) { ?>
                                <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="rnd_span1 font-R"><?php echo $list[$i]['ca_name'] ?></a> 
                                <?php } ?>
                            ...
                            <td class="rb-board-title" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*50) : '15'; ?>px; <?php if($list[$i]['reply']) { ?>background-image:url('<?php echo $board_skin_url ?>/img/ico_rep.svg'); background-position:center left 15px<?php } ?>">
                                    ...
                                    <a href="<?php echo $list[$i]['href'] ?>" class="title_el_a <?php if($list[$i]['is_notice']) { ?>font-B<?php } ?>"><?php echo $list[$i]['subject'] ?></a>
                                    <?php if($list[$i]['comment_cnt']) { ?><span class="fl_icons font-B main_color">+<?php echo number_format($list[$i]['wr_comment']); ?></span><?php } ?>
                                    <div class="cb"></div>
                                
                                <div class="bbs_basic_infos_wrap mobile">
                                    <span class="font-B"><?php echo $list[$i]['name'] ?></span>　
                            ...
                            <td class="rb-board-date board_pc" nowrap><?php echo passing_time3($list[$i]['wr_datetime']); ?></td>
                            <td class="rb-board-views board_pc" nowrap><?php echo number_format($list[$i]['wr_hit']); ?></td>
                        </tr>
