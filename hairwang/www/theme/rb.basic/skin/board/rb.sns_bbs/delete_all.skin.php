<?php
for ($j=$chk_count-1; $j>=0; $j--)
{
    $write = sql_fetch(" select * from $write_table where wr_id = '$tmp_array[$j]' ");
    ...
    $sql = " select * from $write_table where wr_parent = '{$write['wr_id']}' and wr_is_comment = '1' order by wr_id ";
