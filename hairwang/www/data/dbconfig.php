...
define('G5_MYSQL_USER', 'hairwang');
define('G5_MYSQL_PASSWORD', 'gphkddl!!@');
define('G5_MYSQL_DB', 'hairwang');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', 'f120462b2c66d69c4fb7236fe7f1f17c'); // 토큰 암호화에 사용할 키
